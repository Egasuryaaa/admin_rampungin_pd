...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Admin Login Rampungin</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/auth/LogoRampung.png">
    <!--! END: Favicon--> <?php if (!function_exists('base_url')) { helper('url'); } ?>
    <base href="<?= base_url() ?>">
...
<body>
            ...
            <div class="auth-cover-card-wrapper"> 
                <div class="auth-cover-card p-sm-5">
                    <div class="wd-50 mb-5">
                        <img src="<?= base_url('assets/images/auth/LogoRampung.png') ?>" alt="" class="img-fluid">
                    </div>
                    ...
                    <form id="formLogin" action="<?= base_url('auth/login') ?>" method="POST" class="w-100 mt-4 pt-2">
                        ...
                        <div class="mb-3 mt-4">
                            <div class="g-recaptcha" 
                                data-sitekey="6LeRfPUrAAAAALNeGOUZQ5Gd3KssXsu5bpnrO28W"
                        ...
                        <div class="mt-5">
                            <button type="submit" class="btn btn-lg btn-primary w-100" id="loginButton">Login</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        // Define BaseUrlJsQ for AJAX calls
        const BaseUrlJsQ = '<?= base_url() ?>';
    </script>
